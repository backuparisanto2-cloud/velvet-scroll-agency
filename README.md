...
- **Content Layers**: 
  - *Base Layer*: Sketch outline of a city (`https://strvid.nyc3.cdn.digitaloceanspaces.com/cloudinary/hero_city_outline_fzg37d.jpg`) + "Imagine the Future".
  - *Top Layer*: Realistic city skyline (`https://strvid.nyc3.cdn.digitaloceanspaces.com/cloudinary/hero_city_iglhwn.jpg`) + "Build the Reality".
...
- Outline Image: `https://strvid.nyc3.cdn.digitaloceanspaces.com/cloudinary/hero_city_outline_fzg37d.jpg`
- Realistic Reveal Image: `https://strvid.nyc3.cdn.digitaloceanspaces.com/cloudinary/hero_city_iglhwn.jpg`
...
- **SEO Requirements**: Semantic HTML (`

`, ``, `

`, `

`, ``). Include appropriate `alt` attributes on all images. Only one `

` tag per page (in the Hero). Use readable `aria-labels` on icon-only buttons (like the mobile menu toggle).
...
**Live app**: https://velvet-scroll-agency.lovable.app

## Build with Lovable

Continue developing this project in the [Lovable editor](https://lovable.dev/projects/514d9f2d-4baa-470a-be76-63dd22cbc477).
